...
def cpu_style(pct):
    if pct < 50: return Style().fg(Color.green())
    if pct < 80: return Style().fg(Color.yellow())
...
with Terminal() as term:
    while True:
        ...
        def ui(frame, rows=data):
            ...
            frame.render_widget(
                Paragraph.from_string(" ↑/↓: Select  r: Refresh  q: Quit")
        ...
        if ev:
            ...
            elif ev.code == "r":    data = random_data(); last_update = time.time()
