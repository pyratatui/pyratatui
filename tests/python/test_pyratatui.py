...
class TestEffect:
    ...
    def test_slide_in(self):
        from pyratatui import Color, Effect, Interpolation, Motion

        e = Effect.slide_in(
            Motion.LeftToRight, 0, 0, Color.black(), 600, Interpolation.QuadOut
        )
        assert e is not None
    ...
    def test_sweep_in(self):
        ...
        e = Effect.sweep_in(
            Motion.UpToDown, 15, 0, Color.black(), 600, Interpolation.QuadOut
        )
        assert e is not None
